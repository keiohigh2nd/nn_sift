...
def exec_classify(dir,class_name):

    if class_name == "A":
		A_dir = "/home/keiohigh2nd/nn_sift/data/A_dir"
		shutil.move(dir ,A_dir)
    else:
		B_dir = "/home/keiohigh2nd/nn_sift/data/B_dir"
		shutil.move(dir ,B_dir)
...
if __name__ == '__main__':
    ...
    segments = tmp.split("/")
    print segments[-1] 
    cv2.imwrite('../%s.jpg'%segments[-1],img)
